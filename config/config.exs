...
config :personal_finance, PersonalFinanceWeb.Endpoint,
  ...
  pubsub_server: PersonalFinance.PubSub,
  live_view: [signing_salt: "XiOB4LQo"]
  ...
  plugins: [
    {
      Oban.Plugins.Cron,
      crontab: [
        {"0 15 * * *", PersonalFinance.Workers.MarketRatesWorker},
        {"5 15 * * *", PersonalFinance.Workers.YieldsWorker}
      ]
    }
  ],
