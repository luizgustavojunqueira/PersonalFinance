defmodule PersonalFinanceWeb.UserAuth do
  use PersonalFinanceWeb, :verified_routes
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      PersonalFinanceWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule PersonalFinanceWeb.PageLive do
        use PersonalFinanceWeb, :live_view

        on_mount {PersonalFinanceWeb.UserAuth, :mount_current_scope}
        ...
      end
  ...
  def signed_in_path(_), do: ~p"/ledgers"
