      ...
      <div class="bg-base-100 rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div class="flex items-center justify-between p-6 border-b border-base-200">
          <h2 class="text-2xl font-bold text-base-content">
            <.icon name="hero-document-arrow-up" class="w-6 h-6 inline mr-2" />
            Importar Transações
          </h2>
          <button
            ...
            >
              <div class="form-control">
                ...
                <div class="border-2 border-dashed border-base-300 rounded-lg p-8 text-center hover:border-primary transition-colors">
                  <.icon name="hero-cloud-arrow-up" class="w-12 h-12 mx-auto mb-4 text-base-content/50" />
                  <.live_file_input upload={@uploads.file} class="file-input file-input-bordered file-input-primary w-full" />
                  ...
                  <div class="alert alert-error mt-2">
                    ...
                    <span>
                      <%= case err do %>
                        ...
                        <% :not_accepted -> %>Tipo de arquivo não aceito (apenas CSV)
                        <% :too_many_files -> %>Apenas um arquivo por vez
                        <% _ -> %>Erro no upload
                      <% end %>
                    </span>
                  </div>
